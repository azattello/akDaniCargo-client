...
export const addStatus = async (statusText) => {
  ...
  try {
    ...
    const response = await axios.post('http://localhost:3001/api/status/addStatus', {
      statusText
    });
...
export const getStatus = async () => {
  try {
      const response = await axios.get('http://localhost:3001/api/status/getStatus');
...
export const deleteStatus = async (statusId) => {
  try {
    ...
    const response = await axios.delete(`http://localhost:3001/api/status/deleteStatus/${statusId}`);
